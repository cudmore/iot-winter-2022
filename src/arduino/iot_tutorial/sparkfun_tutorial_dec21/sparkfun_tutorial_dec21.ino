...
const char *ssid =  "NETGEAR49";   // name of your WiFi network
...
void setup() {
  ...
  pinMode(SWITCH_PIN,INPUT_PULLUP);  // Configure SWITCH_Pin as an input
...
void loop() {
  ...
  if(digitalRead(SWITCH_PIN) == 0) 
  {
    ...
    {
      Serial.println("abb waiting for pin to be 0");
      delay(20);
    }
  }
}
